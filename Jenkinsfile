  ...
  stages {
   ...
   stage('Nexus upload'){
        steps {
           ...
           nexusArtifactUploader artifacts: [[artifactId: 'app', classifier: '', file: 'target/app 1.0.0.1.war', type: 'war']], credentialsId: 'nexus3', groupId: 'com.mithun', nexusUrl: '3.111.40.42:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'jenkins', version: '1.0.0.1'
     }  
   }
    stage ('Deploy') {
      steps {
